...
import static ru.vladp.config.TestConfig.SITE_URL;
import static ru.vladp.models.BrowsersSupport.CHROME;
import static ru.vladp.models.BrowsersSupport.FIREFOX;
...
public class BaseTest {
    ...
    public void setup(String browser) {
        ...
        if (browser.equalsIgnoreCase(CHROME.getBrowserName())) {
...
//            optionsChrome.addArguments("--headless");
        ...
        } else if (browser.equalsIgnoreCase(FIREFOX.getBrowserName())) {
            WebDriverManager.firefoxdriver().setup();
            FirefoxOptions optionsFirefox = new FirefoxOptions();
            optionsFirefox.setBrowserVersion(TestConfig.FIREFOX_VERSION);
//            optionsFirefox.addArguments("--headless");
            driverThreadLocal.set(new FirefoxDriver(optionsFirefox));
        } else {
