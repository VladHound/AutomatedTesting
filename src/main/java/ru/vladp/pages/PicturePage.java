...
public class PicturePage extends BasePage {
    ...
    @Step("Put the picture at index {index} into the cart")
    public Picture putInCartSpecificPicture(@Param("index") int index) {
        waitForAllElementsTimeoutSeconds(pictureList);
        ...
        assert picture != null;
        cartButton = picture.findElement(By.className("oclick"));
